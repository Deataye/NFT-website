    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="max-w-screen-xl mx-auto px-4 flex flex-col md:flex-row justify-between">
        ...
        <div className="mb-6 md:mb-0">
          <h1 className="text-2xl font-poppins font-bold">MyNFTs</h1>
          <p className="text-sm font-poppins mt-1">Empowering creators and collectors worldwide</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-xl font-poppins font-semibold mb-4">Marketplace</h3>
            <ul>
          ...
          {/* Column 2: Company */}
          <div>
            <h3 className="text-xl font-poppins font-semibold mb-4">Company</h3>
            <ul>
          ...
          <div>
            <h3 className="text-xl font-poppins font-semibold mb-4">Get the Latest Updates</h3>
            <form className="flex flex-col space-y-4">
              ...
              />
              <button className="bg-blue-600 hover:bg-blue-700 font-poppins text-white px-4 py-2 rounded-md">
                Join Our Community
              </button>
            </form>
            <div className="mt-4 flex font-poppins space-x-4">
