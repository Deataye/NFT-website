  ...
  return (
    <section className="bg-[#ECF1FF] px-[90px] py-8">
      <div className="container mx-auto">
              ...
              <button
                className={`px-4 py-2 rounded-lg  ${
                  selectedTimeFrame === "Today"
                    ? "bg-white text-blue-600 font-poppins font-semibold"
                    : "text-gray-600"
                }`}
        ...
        {/* Galleries Section */}
        <div className="flex grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full h-full  ">
          {galleries.map((gallery) => (
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-[16px] leading-[24px] font-poppins  font-semibold">{gallery.name}</h3>
                  <p className="text-gray-500 font-poppins text-[12px] leading-[16px]">
                    Floor: {gallery.floorPrice} ~ $108.7K
                  </p>
                </div>
                <div>
                  <p className="text-[16px] leading-[24px] font-poppins font-semibold">{gallery.price}</p>
                  <p className="text-gray-500 font-poppins text-[12px] leading-[16px]">{gallery.percentageChange}</p>
                </div>
              </div>
            </div>
          ))}
