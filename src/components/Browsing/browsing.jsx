...
const Browsing = () => {
  const categories = [
    { name: 'ART', items: 28, imageSrc: '/art.png' },
    { name: 'Photography', items: 28, imageSrc: '/photography.png' },
    { name: 'ART', items: 28, imageSrc: '/art.png' },
    { name: 'Photography', items: 28, imageSrc: '/photography.png' },
    { name: 'Domains', items: 28, imageSrc: '/domain.png' },
    { name: 'Photography', items: 28, imageSrc: '/photography.png' },
    { name: 'Domains', items: 28, imageSrc: '/domain.png' },
    { name: 'Photography', items: 28, imageSrc: '/photography.png' }
  ];
  ...
  return (
    <div className='w-full flex flex-col py-[100px] bg-[#ECF1FF]'>
      {/* Title */}
