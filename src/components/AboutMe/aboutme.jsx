    ...
    <section className="bg-[#ECF1FF] py-10 ">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between space-y-10 md:space-y-0 px-8">
        ...
        <div className="relative md:w-1/2 w-full flex justify-center items-center space-x-6 mr-6">
          {/* First Image Card */}
          <div className="flex flex-col items-start w-[280px]  h-[300px] rounded-[16px] bg-[rgba(249,249,249,0.7)] shadow-lg">
            <img 
              src="/520.png" 
              alt="Awkward Astronauts" 
              className="w-full h-[256px] rounded-[8px] object-cover p-4"
            />
            <div className="pl-4">
          ...
          {/* Second Image Card */}
          <div className="flex flex-col items-start w-[280px] h-[300px] rounded-[16px] bg-[rgba(249,249,249,0.7)] shadow-lg ml-4 -mt-12">
            <img 
              src="521.png" 
